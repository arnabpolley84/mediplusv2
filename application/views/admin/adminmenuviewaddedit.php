                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div class="divsec">
                                ...
                                ?>
                                <h2>Menus </h2>
                                <?php echo form_open('admin/content/menu'); ?>
                                    <br>
                                    ...
                                    <select required="required" class="formcontrol mnu" name="menu_pid">
                                        ...
                                        if (!empty($menu_data) && count($menu_data) > 0) { ?>
                                            ...
                                            foreach ($menu_data as $key => $value) {
                                                if($value['menu_id'] == $contentdetailscid){ ?>
                                    ...
                                    <input type="hidden" name="menu_link_hid" class="menu_link_hid" value="<?php echo $menu_data[0]['menu_link'] ?>" />
                                    <br>
                                    <br>
                                      ...
                                      ?>
                                        <tr>
                                         ...
                                         <td class="centr">
                                            ...
                                            ?>
                                            <button data-id="<?php echo $value['menu_id'] ?>" data-stat="<?php echo $value['menu_status'] ?>" class="<?php echo $activeclass; ?>"><?= $activestr ?></button>
                                         </td>
